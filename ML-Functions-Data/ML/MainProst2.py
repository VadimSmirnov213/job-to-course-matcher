...
# courses_data = [...]  # Список словарей с информацией о курсах
# vacancy_data = {...}  # Одиночный словарь с информацией о вакансии
# recommendations = get_recommendations(courses_data, vacancy_data, top_n=3)
